...
ConvertSelLtoSelAge <- function(MeanLatAge, LatAgeStDev, Linf, Shape=19, relSelL50, relSelL95) {

# function set up to take relative selectivity parameters.  Redundant now, but still requires arguments in that format until it is fixed.

SelL50 <- relSelL50 * Linf
SelL95 <- relSelL95 * Linf
