...
title: Assessing the status of nearshore California finfish at local scales using
  data-limited approaches or Considerations for the use of MPAs in Data Limited Fisheries Management 
...
* McGillard et al. [-@McGilliard2014]
    ...
    * However, you could still infer something form the seperate signals;if fished density is going down in the reference site whiel unfished density is going down might be a sign to be cautios 
...
* Why Care?
    ...
    * You try and count the fish in the sea, or you adaptively respond 
    ...
    * MPA angle 
        ...
        * Climate ready fisheries: How do you develope adapative management institutions that respond to climate 
        change 
...
* The solution
    ...
    * CCFRP provides a perfect example to evaluate the ability of length and reserve based data to provide useulf data 
...
* Limitations
    ...
    * Spatial stuff
    * MPA SPR
* For a single species, do we see concurance across methods that could guide management?
    ...
    * Do we see concurance from catch curve and LBSPR F/M?
    * How much spatial variability is there?
* For multiple species, do we see concurance across species?
...
* Take Home
    ...
    * Strong evidence that properly designed programs likfe CCFRP, together with fishery independent data, could serve as a data-limited alternative to catch-only methods
    * Further research adressing MSE of these things will be useful
...
5. Some kind of graphical interpretaion of multiple results by species: green yellow red depending on concurrance of metrics? Might be too much
