...
source(paste("Yellowtail snapper\\Montserrat2-LittleBay-Yellowtail snapper_ControlFile.R"))
...
#           {
            ...
            Temp<- LBAR(SampleCheck$ParedData,LagLength=1,Weight=1,IncludeMPA=0,ReserveYr=NA,OutsideBoundYr=NA,Iterations=1000,
                        BootStrap=0,LifeError=0,Lc=40)$Output		
...
#           {
            ...
            Temp2<- LBSPR(SampleCheck$ParedData,EstimateM=0,Iterations=1000,BootStrap=1,
